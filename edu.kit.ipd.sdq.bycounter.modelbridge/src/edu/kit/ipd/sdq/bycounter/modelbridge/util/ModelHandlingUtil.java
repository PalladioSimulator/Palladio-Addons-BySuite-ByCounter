...
public class ModelHandlingUtil {
	...
	/**Returns the resource set used for loading and storing.
	...
	public static void initializeEmfFactories(ResourceSet resourceSet) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("gast", new XMIResourceFactoryImpl());
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("expressions", new XMIResourceFactoryImpl());
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("input", new InputResourceFactoryImpl());
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("output", new OutputResourceFactoryImpl());
