...
public class Main extends SpecJVMBenchmarkBase {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<_MK_numberOfRepetitions ; i++){
	    	...
	    	MK_meas.add(_MK_val);
	    	sum += _MK_val;
	        System.err.println("MK: Scimark.Sparse main "+i+": "+_MK_val+" ns");
	    }
	    System.err.println("MK: Scimark.Sparse 1st from "+_MK_numberOfRepetitions+" meas: "+MK_meas.get(0));
	    Collections.sort(MK_meas);
	    System.err.println("MK: Scimark.Sparse min from "+_MK_numberOfRepetitions+" meas: "+MK_meas.get(0));
	    System.err.println("MK: Scimark.Sparse med from "+_MK_numberOfRepetitions+" meas: "+MK_meas.get(MK_meas.size()/2));
	    System.err.println("MK: Scimark.Sparse avg from "+_MK_numberOfRepetitions+" meas: "+sum/_MK_numberOfRepetitions);
	    System.err.println("MK: Scimark.Sparse max from "+_MK_numberOfRepetitions+" meas: "+MK_meas.get(MK_meas.size()-1));
    }
