...
public final class Harness {
	...
	public String toString(){
		...
		sb.append(MK_fileIndex+"=MK_fileIndex, ");
		sb.append(MK_FILES_NUMBER+"=MK_FILES_NUMBER, ");
		sb.append(MK_lastInputSize+"=MK_lastInputSize, ");
		sb.append(MK_lastInputType+"=MK_lastInputType, ");
		sb.append(MK_lastOutputSize+"=MK_lastOutputSize, ");
		sb.append(Compress.MK_nrOfMeasurements+"=Compress.MK_numberOfMeasurements, ");
//		sb.append(Compress.+"=Compress.MK_numberOfMeasurements, ");
		return sb.toString();
	}
	static class Source {
...
//        	System.out.println("MK calling Harness:Source.Source(String fileName) (constructor)");
     ...
     */
    public static int MK_fileIndex = 0; //30 = tinyText with 33 bytes; number 32 has 8703 bytes
...
//        "resources/compress/input/misc.tar",
    ...
    private static byte[] MK_lastOutput;
    ...
    public static byte[] MK_getLastOutput() {
		return MK_lastOutput;
	}
	...
	private static void MK_setLastOutput(OutputBuffer comprBuffer) {
		MK_lastOutput = comprBuffer.MK_getBuffer();
	}
...
//    	Context.getOut().println("MK Entering *.compress.Harness.inst_main with thread id "+btid);
	...
	public void runCompress(int btid) {//btid = benchmarking thread ID
    	System.out.println("MK calling Harness.runCompress(int btid), "+toString());
...
//                System.out.print(comprBuffer.getLength() + comprBuffer.getCRC() + " ");
                ...
                Harness.MK_setLastOutput(comprBuffer);
