...
public final class Compress {
	...
	public static final int MK_nrOfMeasurements = 1 ; // MK TODO
   ...
   (byte) 0x3f, (byte) 0x7f,	(byte) 0xff };
	...
	public static OutputBuffer performAction(byte[] src, // source
		...
		System.err.println("Mutating: "+MK_mutation);
...
//				}
//			}
			if(MK_nrOfMeasurements>1 && Compress.MK_mutation){
...
//						" from "+origByte+" to "+newByte+": ");
			...
			if (action == COMPRESS) {
				...
				System.err.println("\nTSE "+nsDuration + " ns " + 
						...
						"for source length "+srcLength+"/"+src.length);
				nsDuration = compressionFinish - compressionStart;
