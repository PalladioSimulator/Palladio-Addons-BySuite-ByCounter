...
/**
 * MK Nothing special, nothing to be measured
 *
 */
public class Util {
    ...
    public final static String TEST_DATA_1 =
            TEST_DATA_BASE + "fredmans21.txt"; //MK 1704 bytes
    
    public final static String TEST_DATA_2 =
            TEST_DATA_BASE + "track3.mp3";     //MK 713KB
    
    public final static String TEST_DATA_3 =
            TEST_DATA_BASE + "random96.dat";   //MK 96 bytes
    
    public final static String TEST_DATA_4 =
            TEST_DATA_BASE + "random1024.dat"; //MK 1024 bytes
    
    public final static String TEST_DATA_5 =
            TEST_DATA_BASE + "random65536.dat"; //MK 65536 bytes
    
    public final static String TEST_DATA_6 =
            TEST_DATA_BASE + "random1048576.dat"; //MK 1048576 bytes (1 MB)
    ...
    public final static boolean check(byte [] ba1, byte [] ba2) {
        ...
        if (ba1 == null || ba2 == null) {
            if (DEBUG) System.out.println("Fail null.");//MK ???
            return false;
        }
        ...
        return java.util.Arrays.equals(ba1, ba2);//MK any other options for an array comprison to fail???
    }
}
