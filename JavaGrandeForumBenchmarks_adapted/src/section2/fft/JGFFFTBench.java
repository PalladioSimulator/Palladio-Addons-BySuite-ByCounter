...
public class JGFFFTBench extends FFT implements JGFSection2 {
	...
	public void JGFrun(int size) {
		...
		JGFInstrumentor.addOpsToTimer("Section2:FFT:Kernel",
				(double) (datasizes[size]));
	...
	public void JGFvalidate() {
		...
		double refval[] = { 1.726962988395339, 6.907851953579193,
				13.815703907167297 };
		double refvali[] = { 2.0974756152524314, 8.389142211032294,
				16.778094422092604 };
