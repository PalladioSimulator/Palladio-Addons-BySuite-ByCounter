...
public class JGFMathBench implements JGFSection1 {
	...
	public void JGFrun() {
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AbsInt", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AbsLong", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AbsFloat", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AbsDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MaxInt", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MaxLong", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MaxFloat", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MaxDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MinInt", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MinLong", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MinFloat", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:MinDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:SinDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:CosDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:TanDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AsinDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AcosDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:AtanDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:Atan2Double",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:FloorDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:CeilDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:SqrtDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:ExpDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:LogDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:PowDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:RintDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:Random", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:RoundFloat",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Math:RoundDouble",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Math:IEEERemainderDouble",
				"operations");
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Math:IEEERemainderDouble");
			JGFInstrumentor.addOpsToTimer("Section1:Math:IEEERemainderDouble",
					(double) 16 * size);
			size *= 2;
		}
