...
public class JGFMethodBench implements JGFSection1 {
	...
	synchronized public static void synch_class_method() {
		k++;
	}

	public final void final_instance_method() {
		k++;
	}
	...
	public void JGFrun() {
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Method:Same:Instance",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Method:Same:SynchronizedInstance",
				"calls");
		time = 0.0;
		size = INITSIZE;
		while (time < TARGETTIME && size < MAXSIZE) {
			JGFInstrumentor
					.resetTimer("Section1:Method:Same:SynchronizedInstance");
			JGFInstrumentor
					.startTimer("Section1:Method:Same:SynchronizedInstance");
			for (i = 0; i < size; i++) {
			...
			JGFInstrumentor
					.stopTimer("Section1:Method:Same:SynchronizedInstance");
			time = JGFInstrumentor
					.readTimer("Section1:Method:Same:SynchronizedInstance");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Method:Same:SynchronizedInstance", (double) 16
							* size);
			size *= 2;
		}
		JGFInstrumentor
				.printperfTimer("Section1:Method:Same:SynchronizedInstance");
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Method:Same:FinalInstance");
			JGFInstrumentor.addOpsToTimer("Section1:Method:Same:FinalInstance",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Method:Same:Class",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Method:Same:SynchronizedClass",
				"calls");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			JGFInstrumentor
					.resetTimer("Section1:Method:Same:SynchronizedClass");
			JGFInstrumentor
					.startTimer("Section1:Method:Same:SynchronizedClass");
			for (i = 0; i < size; i++) {
				synch_class_method();
				synch_class_method();
				synch_class_method();
			...
			time = JGFInstrumentor
					.readTimer("Section1:Method:Same:SynchronizedClass");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Method:Same:SynchronizedClass", (double) 16
							* size);
			size *= 2;
		}

		JGFInstrumentor
				.printperfTimer("Section1:Method:Same:SynchronizedClass");
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Method:Other:Instance",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Method:Other:InstanceOfAbstract",
				"calls");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			JGFInstrumentor
					.resetTimer("Section1:Method:Other:InstanceOfAbstract");
			JGFInstrumentor
					.startTimer("Section1:Method:Other:InstanceOfAbstract");
			for (i = 0; i < size; i++) {
				mt2.instance_method();
				mt2.instance_method();
				mt2.instance_method();
			...
			JGFInstrumentor
					.stopTimer("Section1:Method:Other:InstanceOfAbstract");
			time = JGFInstrumentor
					.readTimer("Section1:Method:Other:InstanceOfAbstract");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Method:Other:InstanceOfAbstract", (double) 16
							* size);
			size *= 2;
		}

		JGFInstrumentor
				.printperfTimer("Section1:Method:Other:InstanceOfAbstract");
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Method:Other:Class",
					(double) 16 * size);
			size *= 2;
		}
