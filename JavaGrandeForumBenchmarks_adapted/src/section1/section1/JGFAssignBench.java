...
public class JGFAssignBench implements JGFSection1 {
	...
	public void JGFrun() {
		...
		JGFInstrumentor.addTimer("Section1:Assign:Same:Scalar:Local",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Scalar:Local");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Same:Scalar:Local",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Same:Scalar:Instance",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Scalar:Instance");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Assign:Same:Scalar:Instance", (double) 16 * size);
			size *= 2;
		}

		JGFInstrumentor.printperfTimer("Section1:Assign:Same:Scalar:Instance");

		JGFInstrumentor.addTimer("Section1:Assign:Same:Scalar:Class",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Scalar:Class");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Same:Scalar:Class",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Same:Array:Local",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Array:Local");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Same:Array:Local",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Same:Array:Instance",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Array:Instance");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Assign:Same:Array:Instance", (double) 16 * size);
			size *= 2;
		}

		JGFInstrumentor.printperfTimer("Section1:Assign:Same:Array:Instance");

		JGFInstrumentor.addTimer("Section1:Assign:Same:Array:Class",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Same:Array:Class");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Same:Array:Class",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Other:Scalar:Instance",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Other:Scalar:Instance");
			JGFInstrumentor
					.addOpsToTimer("Section1:Assign:Other:Scalar:Instance",
							(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Other:Scalar:Class",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			// try to defeat dead code elimination
			if (AssignTester.a3 == AssignTester.a4)
				System.out.println(AssignTester.a3);
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Other:Scalar:Class");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Other:Scalar:Class",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Assign:Other:Array:Instance",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			// try to defeat dead code elimination
			if (at.d[3] == at.d[2])
				System.out.println(at.d[3]);
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Other:Array:Instance");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Assign:Other:Array:Instance", (double) 16 * size);
			size *= 2;
		}

		JGFInstrumentor.printperfTimer("Section1:Assign:Other:Array:Instance");

		JGFInstrumentor.addTimer("Section1:Assign:Other:Array:Class",
				"assignments");
		time = 0.0;
		size = INITSIZE;
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			// try to defeat dead code elimination
			if (AssignTester.b[3] == AssignTester.b[2])
				System.out.println(AssignTester.b[3]);
			time = JGFInstrumentor
					.readTimer("Section1:Assign:Other:Array:Class");
			JGFInstrumentor.addOpsToTimer("Section1:Assign:Other:Array:Class",
					(double) 16 * size);
			size *= 2;
		}
