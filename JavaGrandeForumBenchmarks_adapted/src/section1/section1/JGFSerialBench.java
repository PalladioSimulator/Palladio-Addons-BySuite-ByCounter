	...
	public void JGFrun() {
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Serial:Writing:Linklist");

			JGFInstrumentor.addOpsToTimer("Section1:Serial:Writing:Linklist",
					(double) size * 4 * listsize);
		...
		JGFInstrumentor.addOpsToTimer("Section1:Serial:Reading:Linklist",
				(double) size * 4 * listsize);
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Serial:Writing:Binarytree");

			JGFInstrumentor.addOpsToTimer("Section1:Serial:Writing:Binarytree",
					(double) size * 4 * (Math.pow(2, (MAXDEPTH + 1)) - 1));
		...
		JGFInstrumentor.addOpsToTimer("Section1:Serial:Reading:Binarytree",
				(double) size * 4 * (Math.pow(2, (MAXDEPTH + 1)) - 1));
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Serial:Writing:Vector",
		...
		JGFInstrumentor.addOpsToTimer("Section1:Serial:Reading:Vector",
				(double) LENGTH * size * 4);
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Serial:Writing:Array",
					(double) size * LENGTH * 4);
		...
		JGFInstrumentor.addOpsToTimer("Section1:Serial:Reading:Array",
				(double) size * LENGTH * 4);
