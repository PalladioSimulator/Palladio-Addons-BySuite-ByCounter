...
public class JGFCreateBench implements JGFSection1 {
	...
	public void JGFrun() {
		...
		while (n <= max) {
			JGFInstrumentor
					.addTimer("Section1:Create:Array:Int:" + n, "arrays");
			time = 0.0;
			size = INITSIZE;
			while (time < TARGETTIME && size < MAXSIZE) {
				...
				time = JGFInstrumentor.readTimer("Section1:Create:Array:Int:"
						+ n);
				JGFInstrumentor.addOpsToTimer("Section1:Create:Array:Int:" + n,
						(double) 16 * size);
				size *= 2;
			}
		...
		n = 1;
		while (n <= max) {
			JGFInstrumentor.addTimer("Section1:Create:Array:Long:" + n,
					"arrays");
			time = 0.0;
			size = INITSIZE;
			while (time < TARGETTIME && size < MAXSIZE) {
				...
				time = JGFInstrumentor.readTimer("Section1:Create:Array:Long:"
						+ n);
				JGFInstrumentor.addOpsToTimer(
						"Section1:Create:Array:Long:" + n, (double) 16 * size);
				size *= 2;
			}
		...
		n = 1;
		while (n <= max) {
			JGFInstrumentor.addTimer("Section1:Create:Array:Float:" + n,
					"arrays");
			time = 0.0;
			size = INITSIZE;
			while (time < TARGETTIME && size < MAXSIZE) {
				...
				time = JGFInstrumentor.readTimer("Section1:Create:Array:Float:"
						+ n);
				JGFInstrumentor.addOpsToTimer("Section1:Create:Array:Float:"
						+ n, (double) 16 * size);
				size *= 2;
			}
		...
		n = 1;
		while (n <= max) {
			JGFInstrumentor.addTimer("Section1:Create:Array:Object:" + n,
					"arrays");
			time = 0.0;
			size = INITSIZE;
			while (time < TARGETTIME && size < MAXSIZE) {
				...
				time = JGFInstrumentor
						.readTimer("Section1:Create:Array:Object:" + n);
				JGFInstrumentor.addOpsToTimer("Section1:Create:Array:Object:"
						+ n, (double) 16 * size);
				size *= 2;
			}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Create:Object:Base",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Create:Object:Simple",
					(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:Constructor",
				"objects");
		time = 0.0;
		size = INITSIZE;
		aa = new AA();
		while (time < TARGETTIME && size < MAXSIZE) {
			JGFInstrumentor
					.resetTimer("Section1:Create:Object:Simple:Constructor");
			JGFInstrumentor
					.startTimer("Section1:Create:Object:Simple:Constructor");
			for (i = 0; i < size; i++) {
				aa = new AA();
				aa = new AA();
				aa = new AA();
			...
			JGFInstrumentor
					.stopTimer("Section1:Create:Object:Simple:Constructor");
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:Constructor");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Create:Object:Simple:Constructor", (double) 16
							* size);
			size *= 2;
		}
		JGFInstrumentor
				.printperfTimer("Section1:Create:Object:Simple:Constructor");
		System.gc(); // Reclaim memory

		// User defined object with 1 integer field
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:1Field",
				"objects");
		time = 0.0;
		size = INITSIZE;
		a1 = new A1();
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:1Field");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Create:Object:Simple:1Field", (double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:2Field",
				"objects");
		time = 0.0;
		size = INITSIZE;
		a2 = new A2();
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:2Field");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Create:Object:Simple:2Field", (double) 16 * size);
			size *= 2;
		}
		...
		// User defined object with 2 integer fields
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:4Field",
				"objects");
		time = 0.0;
		size = INITSIZE;
		a4 = new A4();
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:4Field");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Create:Object:Simple:4Field", (double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:4fField",
				"objects");
		time = 0.0;
		size = INITSIZE;
		a4f = new A4F();
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:4fField");
			JGFInstrumentor
					.addOpsToTimer("Section1:Create:Object:Simple:4fField",
							(double) 16 * size);
			size *= 2;
		}
		...
		JGFInstrumentor.addTimer("Section1:Create:Object:Simple:4LField",
				"objects");
		time = 0.0;
		size = INITSIZE;
		a4l = new A4L();
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Simple:4LField");
			JGFInstrumentor
					.addOpsToTimer("Section1:Create:Object:Simple:4LField",
							(double) 16 * size);
			size *= 2;
		}
		...
		// User defined object that instantiates another object in it's
		// contructor
		JGFInstrumentor.addTimer("Section1:Create:Object:Complex:Constructor",
				"objects");
		time = 0.0;
		size = INITSIZE;
		abc = new ABC();
		while (time < TARGETTIME && size < MAXSIZE) {
			JGFInstrumentor
					.resetTimer("Section1:Create:Object:Complex:Constructor");
			JGFInstrumentor
					.startTimer("Section1:Create:Object:Complex:Constructor");
			for (i = 0; i < size; i++) {
				abc = new ABC();
				abc = new ABC();
				abc = new ABC();
			...
			JGFInstrumentor
					.stopTimer("Section1:Create:Object:Complex:Constructor");
			time = JGFInstrumentor
					.readTimer("Section1:Create:Object:Complex:Constructor");
			JGFInstrumentor.addOpsToTimer(
					"Section1:Create:Object:Complex:Constructor", (double) 16
							* size);
			size *= 2;
		}
		JGFInstrumentor
				.printperfTimer("Section1:Create:Object:Complex:Constructor");
		System.gc(); // Reclaim memory
