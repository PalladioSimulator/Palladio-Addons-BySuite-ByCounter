...
public class JGFArithBench implements JGFSection1 {
	...
	public void JGFrun() {
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Add:Int", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Add:Long",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Add:Float",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Add:Double",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Mult:Int",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Mult:Long",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Mult:Float",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Mult:Double",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Div:Int", (double) 16
					* size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Div:Long",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Div:Float",
					(double) 16 * size);
			size *= 2;
		}
		...
		while (time < TARGETTIME && size < MAXSIZE) {
			...
			JGFInstrumentor.addOpsToTimer("Section1:Arith:Div:Double",
					(double) 16 * size);
			size *= 2;
		}
