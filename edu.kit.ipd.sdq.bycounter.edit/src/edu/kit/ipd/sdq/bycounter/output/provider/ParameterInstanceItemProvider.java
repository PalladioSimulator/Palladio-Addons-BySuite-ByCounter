...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.bycounter.output.ParameterInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterInstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterInstance_formalParameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterInstance_formalParameter_feature", "_UI_ParameterInstance_type"),
				 OutputPackage.Literals.PARAMETER_INSTANCE__FORMAL_PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OutputPackage.Literals.PARAMETER_INSTANCE__PARAMETER_CHARACTERISATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.PARAMETER_INSTANCE__PARAMETER_CHARACTERISATION,
				 OutputFactory.eINSTANCE.createDoubleCharacterisation()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.PARAMETER_INSTANCE__PARAMETER_CHARACTERISATION,
				 OutputFactory.eINSTANCE.createLongCharacterisation()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.PARAMETER_INSTANCE__PARAMETER_CHARACTERISATION,
				 OutputFactory.eINSTANCE.createBooleanCharacterisation()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.PARAMETER_INSTANCE__PARAMETER_CHARACTERISATION,
				 OutputFactory.eINSTANCE.createStringCharacterisation()));
	}
