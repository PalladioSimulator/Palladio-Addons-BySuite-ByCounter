...
public class Dhrystone extends DhrystoneGlobalVariables {
	public static boolean _MK_executeOnce = false;
	
	public static boolean _MK_measureEvenIfExecutingOnce = false;

	public static boolean _MK_measureInExecute = false;

	/**
	 * Change this to run quicker in Xint mode
	 */
	public static int _MK_nrOfMeasurements = 256; //8192;
	...
	private static void main() {
		...
		if(_MK_executeOnce){//how can we know that the method is not pure?
			if(_MK_measureEvenIfExecutingOnce){
				...
				executeResultSum += execute(_MK_measureInExecute);
		...
		double sum = 0D;
		for(int n=0; n<_MK_nrOfMeasurements; n++){
			long start = System.nanoTime();
			executeResultSum += execute(_MK_measureInExecute);
			long stopp = System.nanoTime();
...
//		+ " millisec.");
	...
	public static void Proc_1(DhrystoneRecord_Type Pointer_Par_Val) {
	...
	public static void Proc_2(int Int_Par_Ref[]) {
		int Int_Loc;
		int Enum_Loc;
	...
	public static void Proc_3(DhrystoneRecord_Type Pointer_Par_Ref) {
		if (Record_Glob != null)
	...
	public static void Proc_5() {//aaaaa...
		Char_Glob_1 = 'A';
		Bool_Glob = false;
	}

	public static void Proc_6(int Enum_Par_Val, int Enum_Par_Ref[]) {
	...
	public static void Proc_7(int Int_Par_Val1, int Int_Par_Val2, int Int_Par_Ref[]) {
		int Int_Loc;
		Int_Loc = Int_Par_Val1 + 2;
		Int_Par_Ref[0] = Int_Par_Val2 + Int_Loc;
	}

	public static void Proc_8(int[] Array_Par_1_Ref, int[][] Array_Par_2_Ref,
