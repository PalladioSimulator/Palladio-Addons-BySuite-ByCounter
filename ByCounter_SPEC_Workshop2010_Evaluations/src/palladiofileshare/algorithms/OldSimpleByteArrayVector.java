...
public class OldSimpleByteArrayVector extends Vector<byte[]> {
	...
	@SuppressWarnings("null")//this is a shortcoming of the Eclipse compiler: 
	//it does not realize that "else if(left.length!=right.length){" can only 
	//be reached if "left!=null" in this case, because of the two checks ahead 
	...
	public synchronized boolean add(byte[] addedElement){
