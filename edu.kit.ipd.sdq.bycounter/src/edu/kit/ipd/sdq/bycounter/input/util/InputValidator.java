...
public class InputValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Summationexcludesonlyallowedifsummationisactiveandaggregate Internal Calls Transparentlyistrue' of 'Instrumentation Profile'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int INSTRUMENTATION_PROFILE__SUMMATIONEXCLUDESONLYALLOWEDIFSUMMATIONISACTIVEANDAGGREGATE_INTERNAL_CALLS_TRANSPARENTLYISTRUE = 1;
	...
	public boolean validateInstrumentationProfile(InstrumentationProfile instrumentationProfile, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateInstrumentationProfile_SummationexcludesonlyallowedifsummationisactiveandaggregateInternalCallsTransparentlyistrue(instrumentationProfile, diagnostics, context);
		return result;
	}

	/**
	 * Validates the SummationexcludesonlyallowedifsummationisactiveandaggregateInternalCallsTransparentlyistrue constraint of '<em>Instrumentation Profile</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateInstrumentationProfile_SummationexcludesonlyallowedifsummationisactiveandaggregateInternalCallsTransparentlyistrue(InstrumentationProfile instrumentationProfile, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return instrumentationProfile.SummationexcludesonlyallowedifsummationisactiveandaggregateInternalCallsTransparentlyistrue(diagnostics, context);
	}
