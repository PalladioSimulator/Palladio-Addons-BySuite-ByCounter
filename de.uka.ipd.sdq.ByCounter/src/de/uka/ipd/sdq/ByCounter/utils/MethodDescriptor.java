...
public final class MethodDescriptor implements Comparable<MethodDescriptor>, Serializable{
	 ...
	 * -1 is returned.
	 */
	public static int findMethodInList(
	...
	/**
	 * @param canonicalClassName Fully qualified class name.
	 ...
	 * For example: "V" for "void". For class types, the the package seperator 
	 ...
	 * types may be omitted (and are ignored) so that "List" and "List<Integer>"
	 ...
	 * @param descriptor Method descriptor {@link #getDescriptor()}.
	...
	/**
	 * @return A {@link UUID} for this instance of the MethodDescriptor. This 
	 * can be used to provide context to the counting of the specified method.
	 * Used for debugging at this point.
	 */
	...
	/**
	 * @see #getContext()
	 * @param context A new context UUID to set, replacing the old one.
	 */
	 ...
	 * immediately instead.
	 * @param inlineImmediately When true, inlining of this method is active.
	 */
	 ...
	 * @param isInvariant True marks the method as invariant.
	 */
	 ...
	 * @see #getPackageName()
	 * @param packageName The package name to change to.
	 */
	 ...
	 * @param className The class name to change to.
	 */
	...
	public String toString(){
		String ret = 
			...
			"  inlineImmediately="+isInlineImmediately();
		return ret;
	}
